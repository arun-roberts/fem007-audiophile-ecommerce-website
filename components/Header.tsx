...
const Header = () => {
    ...
    let { isNavVisible, shoppingCart } = value.state
    let { setIsNavVisible } = value
    const { pathname } = useRouter()

    const cartCount = shoppingCart.reduce((a: number, b: CartItem) => a + b.number, 0)
